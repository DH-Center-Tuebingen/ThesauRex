        ...
        <div class="row flex-grow-1 of-hidden">
                ...
                <div class="col px-0 d-flex flex-column mb-2 of-hidden">
                    ...
                    <ul class="list-group list-group-xs scroll-y-auto">
                        ...
                        >
                            ...
                            <span
                                class="help-handle"
                                v-if="!state.canDeleteTopLevelState"
                            ...
                            <span
                                v-show="state.hoverStates.broaders.isTop && state.canDeleteTopLevelState"
                                @click="updateTopLevelState()"
                            >
                                <span
                                    v-if="state.concept.is_top_concept"
                                    class="clickable"
                                >
                                    <i
                                        key="top-delete-icon"
                        ...
                        >
                            ...
                            <span
                                class="text-primary help-handle"
                ...
                <div class="col px-0 d-flex flex-column mb-2 of-hidden">
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                v-show="state.hoverStates.narrowers[i]"
                    ...
                    <p
                        class="mb-0 alert alert-primary px-2 py-1"
                        v-else
                    >
                        <i class="fas fa-fw fa-times"></i>
            ...
            <div class="col-md-6 h-100 d-flex flex-column">
                <div class="col px-0 d-flex flex-column mb-2 of-hidden">
                    <header class="d-flex justify-content-between">
                        ...
                        >
                            <i
                                ...
                                class="fas fa-fw fa-triangle-exclamation"
                            ></i>
                        </span>
                    </header>
                    <form
                    ...
                    >
                        <LocalizedInput
                            v-model:modelLanguage="state.addLabel.language"
                ...
                <div class="col px-0 d-flex flex-column mb-2 of-hidden">
                    ...
                    >
                        <LocalizedInput
                            v-model:modelLanguage="state.addNote.language"
