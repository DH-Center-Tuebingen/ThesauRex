                ...
                >
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li
                            ...
                            v-if="state.loggedIn && state.hasMultipleLanguages"
                        >
                            <LanguageQuickSelect />
                        </li>
                        <li class="nav-item">
                        ...
                        <li
                            class="nav-item"
                            v-if="state.hasSpacialistLink"
                        >
                            <a
                                :href="state.spacialistLink"
                                class="nav-link"
                                target="_blank"
                            >
                                {{ t('global.spacialist') }}
        ...
        <div class="container-fluid col overflow-hidden">
            ...
            <template v-else>
                <div class="h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <h1 class="mt-5"><span class="fw-light">{{ t('app.loading_screen_msg') }}</span>&nbsp;{{
                        state.appName }}&nbsp;<span class="fw-light">&hellip;</span></h1>
                </div>
            </template>
        </div>
